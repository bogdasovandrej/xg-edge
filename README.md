...
проверенные активные книги (`Bet365`, `Unibet`, `William Hill`, `Betway`,
`Betfair Sportsbook`), а их closing consensus остаётся диагностическим и не
подменяет подтверждающий Pinnacle CLV.
